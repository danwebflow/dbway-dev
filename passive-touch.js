...
(function () {
  ...
  EventTarget.prototype.addEventListener = function (type, listener, options) {
    ...
    if (type === "touchstart") {
      // If the event target is inside video player controls, do not force passive
      if (this instanceof Element && (this.closest(".video-controls") || this.closest(".player-item"))) {
